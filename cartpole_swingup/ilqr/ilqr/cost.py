...
class AutoDiffCost(Cost):
    ...
    def __init__(self, l, l_terminal, x_inputs, u_inputs, i=None, **kwargs):
        ...
        Args:
            l: Vector aesara tensor expression for instantaneous cost.
                This needs to be a function of x and u and must return a scalar.
            l_terminal: Vector aesara tensor expression for terminal cost.
                This needs to be a function of x only and must retunr a scalar.
            x_inputs: aesara state input variables [state_size].
            u_inputs: aesara action input variables [action_size].
            i: aesara tensor time step variable.
