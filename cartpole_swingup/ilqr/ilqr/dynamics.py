...
class AutoDiffDynamics(Dynamics):
    ...
    def __init__(self, f, x_inputs, u_inputs, i=None, hessians=False, **kwargs):
        ...
        Args:
            f: Vector aesara tensor expression.
            x_inputs: aesara state input variables.
            u_inputs: aesara action input variables.
...
def tensor_constrain(u, min_bounds, max_bounds):
    ...
    This is implemented with aesara, so as to be auto-differentiable.
