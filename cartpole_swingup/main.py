...
def sample_rand_traj():
    ...
    traj_file_path = '/home/robo/ext_ctrl/cartpole_swingup/ext_ctrl/traj/trajs/'
...
def train():
    ...
    dir = "cartpole_swingup_pretrained"
    ...
    for update in range(1, num_updates + 1):
        ...
        '''
        interm_weights = [w_x, w_theta, w_x_dot, w_theta_dot, w_u, 0]
        ...
        for step in range(0, args.num_steps):
            ...
            interm_weights[5] = step # hack for time, TODO: figure out why the env don't update function in runtime
